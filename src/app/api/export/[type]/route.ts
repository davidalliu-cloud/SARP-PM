    ...
    const body = csvRows(
      ...
      projects.map((project) => {
        ...
        return [
          ...
          project.estimatedContractValue > 0 ? ((project.estimatedContractValue - project.budgetAmount) / project.estimatedContractValue) * 100 : "",
          project.estimatedContractValue > 0 ? project.estimatedContractValue - project.budgetAmount : "",
